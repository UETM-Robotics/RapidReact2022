package frc.robot.Utilities.RamseteTrajectory;
...
public class temp extends CommandBase {
  ...
  public temp(
    ...
    m_trajectory = requireNonNullParam(trajectory, "trajectory", "temp");
    m_pose = requireNonNullParam(pose, "pose", "temp");
    m_follower = requireNonNullParam(controller, "controller", "temp");
    m_feedforward = feedforward;
    m_kinematics = requireNonNullParam(kinematics, "kinematics", "temp");
    m_speeds = requireNonNullParam(wheelSpeeds, "wheelSpeeds", "temp");
    m_leftController = requireNonNullParam(leftController, "leftController", "temp");
    m_rightController = requireNonNullParam(rightController, "rightController", "temp");
    m_output = requireNonNullParam(outputVolts, "outputVolts", "temp");
  ...
  /**
   * Constructs a new temp that, when executed, will follow the provided trajectory.
