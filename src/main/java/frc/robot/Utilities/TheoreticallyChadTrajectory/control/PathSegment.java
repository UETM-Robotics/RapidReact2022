package frc.robot.Utilities.TheoreticallyChadTrajectory.control;
...
import frc.robot.Utilities.TheoreticallyChadTrajectory.motion.MotionProfile;
import frc.robot.Utilities.TheoreticallyChadTrajectory.motion.MotionProfileConstraints;
import frc.robot.Utilities.TheoreticallyChadTrajectory.motion.MotionProfileGenerator;
import frc.robot.Utilities.TheoreticallyChadTrajectory.motion.MotionProfileGoal;
import frc.robot.Utilities.TheoreticallyChadTrajectory.motion.MotionState;
...
public class PathSegment {
    ...
    public void createMotionProfiler(MotionState start_state, double end_speed) {
        MotionProfileConstraints motionConstraints = new MotionProfileConstraints(maxSpeed,
                TechConstants.kPathFollowingMaxAccel);
